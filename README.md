...
| **⚔️ Режимы обучения (Training Modes)** | ⏳ В планах | Стейт-машина сессий, симуляторы для режимов "Интервью" (стресс-симулятор с закрытыми оценками) и "Песочница" (свободный режим с мгновенным фидбеком). |
...
### 🟡 Этап 3: Слой работы с аудио (Media & STT) — **СЛЕДУЮЩИЙ ШАГ**
...
### 🟡 Этап 4: Бизнес-логика и Режимы тренировки (Business Logic & Training) — **СЛЕДУЮЩИЙ ШАГ**
- [ ] **Стейт-машина сессий**: Дирижер логики состояний для пошагового прохождения интервью в UI.
...
- [ ] **Режим "Песочница" (Sandbox / Свободный)**: Свободный режим с возможностью выбора тем, пропуска вопросов и получения мгновенного ИИ-фидбека.
- [ ] **Интервальное повторение (Spaced Repetition)**: Сохранение истории ответов (`ANSWER_HISTORY`) и расчет Confidence Score по темам для адаптивного подбора вопросов.
